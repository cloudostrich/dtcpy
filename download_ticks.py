...
addr_hist = ("192.168.1.100", 11098)
encoding = Dtc.PROTOCOL_BUFFERS
# encoding = Dtc.BINARY_ENCODING
sock = socket.create_connection(addr_hist)
...
# send_message(secdef_req, Dtc.SECURITY_DEFINITION_FOR_SYMBOL_REQUEST,sock)
# hist_req = create_histprcdat_req(1,'F.US.ZFTU19', 'SGX',0)

hist_req = create_histprcdat_req(888, 'F.US.CLEQ19', "Globex",0)
send_message(hist_req, Dtc.HISTORICAL_PRICE_DATA_REQUEST,sock)
